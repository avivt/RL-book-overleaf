...
\varepsilon
\]
for $\alpha\leq \frac{(1-\discount)^2\varepsilon}{\Rmax\discount}$
...
\[
m\tHorizon|\States|\;|\Actions|=O(\frac{\Rmax^2}{\varepsilon^2} \tHorizon^5 |\States|\;|\Actions| (|\States|+\log
(|\States|\;|\Actions|/\delta)))
\]
and for the discounted return
\[
m|\States|\;|\Actions|=O(\frac{\Rmax^2}{\varepsilon^2(1-\discount)^4} |\States|\;|\Actions| (|\States|+\log (|\States|\;|\Actions|/\delta)))
%\log^4\frac{\Rmax}{\varepsilon(1-\discount)})
\]
